...
class Hash
{
    private const string CONFIG_ENCRYPTION_MODE = 'WISE.encryption_mode';
    private const string CONFIG_ENCRYPTION_KEY  = 'WISE.encryption_key';
    private const string CONFIG_BCRYPT_ALGO     = 'WISE.bcrypt_algo';
